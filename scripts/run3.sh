...
python metagan_mnist.py --model metagan1 --n_steps 400000 --gpu_id 0 --lambda_ent 0.1
python metagan_mnist.py --model metagan1 --is_train 0 --n_steps 400000 --gpu_id 0 --lambda_ent 0.1
python metagan_mnist_cp.py --model metagan1 --n_steps 400000 --gpu_id 1 --lambda_ent 0.1
