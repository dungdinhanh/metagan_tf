...
class DCGAN(object):
    ...
    def create_model(self):
        ...
        with tf.variable_scope('discriminator'):
            ...
            self.d_real_sigmoid,  self.d_real_logit = self.D(self.X,   self.data_shape, dim = self.df_dim, reuse=False)
            self.d_fake_sigmoid,  self.d_fake_logit = self.D(self.X_f, self.data_shape, dim = self.df_dim, reuse=True)
