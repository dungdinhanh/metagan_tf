...
python metagan_mnist.py --model metagan1 --n_steps 400000 --gpu_id 1 --lambda_ent 0.15
python metagan_mnist.py --model metagan1 --is_train 0 --n_steps 400000 --gpu_id 1 --lambda_ent 0.15
python metagan_mnist_cp.py --model metagan1 --n_steps 400000 --gpu_id 1 --lambda_ent 0.15
