...
from test_net.metagan_general_ss import MetaGAN
...
if __name__ == '__main__':
    ...
    ********************************************************************
    ...
    if is_train == 1:
        ...
        mtgan.checkpoint_train_history()


    elif is_train == 0:
        # compute fid score
        compute_fid_score(dbname=db_name, input_dir=out_dir, model=model_dir, nb_train=nb_test_real,
